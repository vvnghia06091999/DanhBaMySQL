 ...
 * Use the {@link NhomFragment#newInstance} factory method to
...
public class NhomFragment extends Fragment {
    ...
    public static NhomFragment newInstance(String param1, String param2) {
        NhomFragment fragment = new NhomFragment();
